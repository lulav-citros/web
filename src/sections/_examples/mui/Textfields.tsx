    ...
    return (
        <Masonry columns={{ xs: 1, md: 2 }} spacing={3}>
            <Block title="General" sx={style}>
                ...
                <TextField variant={variant} required fullWidth label="Activated" defaultValue="Hello Minimal" />
                ...
                <TextField variant={variant} disabled fullWidth label="Disabled" defaultValue="Hello Minimal" />
            </Block>
            ...
            <Block title="Multiline" sx={style}>
                <TextField variant={variant} fullWidth label="Multiline" multiline maxRows={4} value="Controlled" />
