...
import { Box, Paper, AppBar, Drawer, Button, Toolbar, Divider, ListItemButton } from '@mui/material';
// hooks
            ...
            <>
                <AppBar position="absolute" color="transparent" sx={{ boxShadow: 0 }}>
                    <Toolbar sx={{ justifyContent: 'flex-end' }}>
                        <Button variant="soft" startIcon={<Iconify icon="eva:menu-2-fill" />} onClick={handleOpen}>
                            Categories
                        </Button>
                    </Toolbar>
                    <Divider />
