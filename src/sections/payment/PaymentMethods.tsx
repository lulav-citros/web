...
function PaymentOption({ option, hasChild, isSelected, isCreditMethod, onOpen }: PaymentOptionProps) {
    ...
    return (
        ...
        >
            ...
            <Stack spacing={1} direction="row" alignItems="center" sx={{ position: 'absolute', right: 20, top: 24 }}>
                {icons.map((icon) => (
            ...
            {isCreditMethod && (
                ...
                >
                    ...
                    <Button size="small" startIcon={<Iconify icon="eva:plus-fill" />} onClick={onOpen} sx={{ my: 3 }}>
                        Add new card
                    </Button>
                </Stack>
            )}
