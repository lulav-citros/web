        ...
        <StyledContent>
            ...
            {isMd && (
                <StyledRow>
                    ...
                    <m.div variants={varFade().in}>
                        <FormControlLabel control={<Radio color="error" defaultChecked />} label="Radio Button" />
                    </m.div>
                    ...
                    <m.div variants={varFade().in}>
                        <FormControlLabel control={<Checkbox color="warning" indeterminate />} label="Checkbox" />
                    </m.div>
                </StyledRow>
            )}
