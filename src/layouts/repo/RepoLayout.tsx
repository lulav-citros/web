...
import generateConfig from './config/repo';
...
export default function RepoLayout({ children, hideHeader }: Props) {
    const { query } = useRouter();

    const [open, setOpen] = useState(false);

    const navConfigItems = useMemo(() => {
        // console.log("generateConfig(query.repo_name as string)", query.repo_name);
